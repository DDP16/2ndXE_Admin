...
import { LayoutGrid, Users, FileText, Shield, Settings, LogOut } from 'lucide-react';
...
const Sidebar = () => {
    ...
    const menuItems = [
        ...
        { label: 'Accounts', icon: <Users className="w-5 h-5" />, path: '/accounts' },
        { label: 'Posts', icon: <FileText className="w-5 h-5" />, path: '/posts' },
        { label: 'Moderation', icon: <Shield className="w-5 h-5" />, path: '/moderation' },
    ];
    ...
    return (
        ...
        >
            <div>
                <Link to="/" >
                    <div className="py-5 text-xl font-bold text-primary text-center">2ndXE</div>
                </Link>
            </div>
            ...
            <div className='py-5 space-y-3'>
                ...
                >
                    <div
                        className={`flex flex-col items-center py-3 px-2 rounded-lg transition-all duration-200 text-gray-500 hover:bg-gray-100`}
                    >
